            ...
            if (showHelperLines){
                drawLine(
                    ...
                    strokeWidth = if (selectedDataPointIndex == index){
                        style.helperLinesThicknessPx*3f
...
private fun getSelectedDataPointIndex(
    ...
    return drawPoints.indexOfFirst {
        it.x in triggerRangeRight .. triggerRangeRight
    }
